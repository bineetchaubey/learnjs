...
var mountainsBG = $('.mountains-bg'); // use to move image 
var mountainsBgIMG = $('.mountains-bg-img'); // use in km background-image
...
$(document).ready(function() {
	...
	setTimeout(function(){
		...
		var openProjectKm = $('.home-proj-1-info');
		var openProjectFaqKm = $('.home-proj-1-info-faq');
		var openProjectCarrierKm = $('.home-proj-1-info-carrier');
		...
		openProjectKm.on('click', function(e){
			console.log('openProjectKm');
			thisNodeLink=$(this);
			openKMNewCustomContent();
		});
		
		openProjectFaqKm.on('click', function(e){
			console.log('openProjectKmFaq');
			thisNodeLink=$(this);
			openKMNewCustomContent();
		});
		
		
		openProjectCarrierKm.on('click', function(e){
			console.log('openProjectKmcarrier');
			thisNodeLink=$(this);
			openKMNewCustomContent();
		});
	...
	.on('mouseover', function(e){
		console.log('js-pause-vid over');
		fastVideoMask(document.getElementById("two-one"));
	});

	$('.js-pause-vid')
	.on('mouseout', function(e){
		console.log('js-pause-vid overout');
	...
	$('.directors .js-hit-area').on('mouseover', function(e){
		console.log('.directors .js-hit-area over');
	...
	$('.director-showcases .js-hit-area').on('mouseover', function(e){
		console.log('.director-showcases .js-hit-area');
		activateCloseBtn();
	});

	$('.director-showcases .js-hit-area').on('mouseout', function(e){
		console.log('.director-showcases .js-hit-area out');
		deactivateCloseBtn();
	});
...
/**   
*  this function take  content from perch-info-nodes class die and push 
* content on  list-nav ul li which is display cantent on list view
*  how we are goting to hide this and displa original conetnt from list-nav location
*/
...
function openPanoContentOverlay() {
	console.log('openPanoContentOverlay');
	$('.mountains-bg-img').css("background-image", 'url(img/bg/home-panorama.jpg)');
...
function openAboutUsContentOverlay() {
	console.log('openAboutUsContentOverlay');
	 $('.mountains-bg-img').css("background-image", 'url(img/bg/about-us.jpg)');
	continueAfterBGSet();
}

function openServicesContentOverlay() {
	console.log('openServicesContentOverlay');
	$('.mountains-bg-img').css("background-image", 'url(img/bg/services.jpg)');
	continueAfterBGSet();
}

function openVRXContentOverlay() {
	console.log('openVRXContentOverlay');
	// this image id display when click any button
 	$('.mountains-bg-img').css("background-image", 'url(img/bg/vrx-portal.jpg)');
	continueAfterBGSet();
}


function openKMNewCustomContent() {
	console.log('openKMNewCustomContent');
	// this image id display when click any button
 	$('.mountains-bg-img').css("background-image", 'url(img/bg/services.jpg)');
	continueAfterBGSet();
}
...
function continueAfterBGSet(){
	console.log('continueAfterBGSet');
	
	// this image id display when click any button
 	$('.generic-bg').css("background", 'rgba(0, 0, 0, 0.8)').css('opacity', 0.3);
	panoContent.show();
	/* $('.mountains-vid').hide(); */
	projectNav.show();
	swapOverlayContent();
...
function swapOverlayContent() {
	console.log('swapOverlayContent');
...
function closePanoContentOverlay() {
	console.log('closePanoContentOverlay');	
	 /* revert back original image when user click close button */
	$('.mountains-bg-img').css("background-image", 'url(img/bg/home-panorama.jpg)');
	/* revert back backend overlay color to original  button */
	$('.generic-bg').css("background", 'none').css('opacity', 0);
...
function panoramaObjectMovement(e, objectsSpeed) {
	...
	TweenMax.to(e,
		objectsSpeed, {
			...
			rotationY: 0,     // stop rotate cicle in x and y direction when move over window
			rotationX: 0,
			ease: 'circ.easeInOut'
...
function changeProjectContent(n) {
	console.log('changeProjectContent');
	if (n == 1) {
...
function loadSite() {
	...
	preload.loadFile("/img/bg/about-us.jpg");
	preload.loadFile("/img/bg/services.jpg");
	preload.loadFile("/img/bg/vrx-portal.jpg");
...
function deactivateNavs() {
	console.log('deactivateNavs');
	$('.nav-wrap').addClass('inactive');
}

function activateNavs() {
	console.log('activateNavs');
...
function showRemoveMainTitle(hideE) {
	console.log('showRemoveMainTitle');
	setTimeout(function(){
